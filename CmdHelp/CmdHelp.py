...
class CmdHelper:
    ...
    parser.add_argument('--nn-structure', type=str, default='100,100,100,100,100', metavar='NNS',
                        help='Neural Network hidden layer size')
    parser.add_argument('--L', type=int, default=5, help='maximum number of hidden layers')
    ...
    parser.add_argument('--iterations', type=int, default=10**4, help='number of iterations')
